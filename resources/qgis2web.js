...
map.getView().fit([-7350477.427363, -2888627.025801, -7211210.222986, -2812646.450310], map.getSize());
...
map.on("rendercomplete", function (evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://github.com/tomchadwin/qgis2web">PEPENAL</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://openlayers.org/">IRIBARNEGARAY</a> &middot; ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="https://qgis.org/">J.CORREA</a>';
